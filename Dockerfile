...
RUN VUE_APP_API_TOKEN=$VUE_APP_API_TOKEN \
    VUE_APP_SERVER_URL=$VUE_APP_SERVER_URL \
    VUE_APP_GITHUB_CLIENT_ID=$VUE_APP_GITHUB_CLIENT_ID \
    VUE_APP_GITHUB_CLIENT_SECRET=$VUE_APP_GITHUB_CLIENT_SECRET \
    VUE_APP_GITHUB_CALLBACK_URL=$VUE_APP_GITHUB_CALLBACK_URL \
