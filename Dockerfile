...
RUN export VUE_APP_SERVER_URL=$VUE_APP_SERVER_URL && export VUE_APP_GITHUB_CLIENT_ID=$VUE_APP_GITHUB_CLIENT_ID && export VUE_APP_GITHUB_CALLBACK_URL=$VUE_APP_GITHUB_CALLBACK_URL && npm run build
